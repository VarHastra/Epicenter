...
class TileThreelineView : FrameLayout {
    ...
    fun init(context: Context, attrs: AttributeSet?) {
        View.inflate(context, R.layout.view_tile_threeline, this)
        ...
        thirdLineTextTextView = findViewById(R.id.tv_tile_text_third)
        iconImageView = findViewById(R.id.iv_tile_icon)

        val styleAttrs = context.obtainStyledAttributes(attrs, R.styleable.TileThreelineView)
        styleAttrs.apply {
    ...
    fun setThirdLineText(@StringRes stringRes: Int) {
        thirdLineTextTextView.setText(stringRes)
    }

    fun setThirdLineText(text: String) {
        thirdLineTextTextView.text = text
    }
